...
namespace GrammatikLaxen.Controllers
{
    public class SpelController : Controller
    {
        ...
        //ÖVNING BAS
        public ActionResult Niva0Spel()
        {
            return View();
        }
        public ActionResult Niva0LaddaSpelet()
        {
            ...
            return PartialView("_Spel", grammatikFraga);
        }

        //ÖVNING LÄTT
        public ActionResult Niva1Spel()
        {
            return View();
        }
        public ActionResult Niva1LaddaSpelet()
        {
            List<FragaSvar> fragaSvarList = new List<FragaSvar>();
            fragaSvarList.Clear();
            ...
            int fragaNummer = 0;
            Random rand = new Random();
            int randSvarighetsgrad = rand.Next(1, 2);
        ...
        //ÖVNING MEDEL
        public ActionResult Niva2Spel()
        {
            return View();
        }
        public ActionResult Niva2LaddaSpelet()
        {
            List<FragaSvar> fragaSvarList = new List<FragaSvar>();
            fragaSvarList.Clear();
            ...
            int fragaNummer = 0;
            Random rand = new Random();
            int randSvarighetsgrad = rand.Next(1, 3);
